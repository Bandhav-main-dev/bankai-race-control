...
def _sf_focus_render_global():
    """
    SOUL FORGE GLOBAL TIMER

    Timer visibility rule:

        timer_started == True
            -> show timer at top of page
    ...
    # =========================================================================
    # DETERMINE WHETHER TIMER HAS ACTUALLY STARTED
    # =========================================================================
    ...
    # Also recognize the existing running state.
    timer_running = bool(
        st.session_state.get(
            "sf_focus_running",
            False,
    ...
    if not timer_started:
        ...
        #
        # We deliberately DO NOT delete the selected task.
        # The user can still select a task before starting.
        # ---------------------------------------------------------------------
    ...
    # =========================================================================
    # TIMER STARTED — FIND ACTIVE TASK
    # =========================================================================
    ...
    if active_task in (
        ...
        active_task = "No task selected"

    # =========================================================================
    # DETERMINE PAUSED / RUNNING
    # =========================================================================
    ...
    # =========================================================================
    # END-TIME BASED TIMER
    # =========================================================================

    if remaining is None:

        import time as _sf_focus_time
    ...
    # =========================================================================
    # TIMER BAR — ONLY REACHED WHEN TIMER STARTED
    # =========================================================================
